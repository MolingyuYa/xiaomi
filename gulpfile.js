...
gulp.task('copyImage', done => {
    gulp.src("image/**").pipe(gulp.dest("dist/image"));
    done();
});//拷贝image
...
gulp.task('watch', done => {
    ...
    gulp.watch('image/**', gulp.series('copyImage'));
...
gulp.task("default", gulp.series("copydata", "copyJavaScript", "copyIndex", "copyHtml", "copyFont", "copySass", "copyCss", 'copyImg', 'copyJs', 'copyImage', "watch", "server"));